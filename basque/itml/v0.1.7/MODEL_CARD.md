...
- Model date: December 30, 2022
- Model type: `Speech-to-Text`
- Model version: `v0.1.7`
- Compatible with 🐸 STT version: `v0.9.3`
- Code: [commonvoice-docker xzuazo's fork](https://gitlab.com/xzuazo/commonvoice-docker)
- License: AGPL
- Citation details: `@techreport{basque-stt, author = {de Zuazo,Xabier}, title = {Basque STT 0.1.7}, institution = {Aholab}, address = {\url{https://aholab.ehu.eus/}} year = {2022}, month = {December}, number = {STT-CV12-EU-0.1.7} }`
...
This model was trained on Common Voice 12 train.

## Evaluation data

The Model was evaluated on Common Voice 12 test.
